...
drop database if exists twitter_table3 cascade;

create database twitter_table3;
use twitter_table3;
...
LOCATION '/user/cloudera/tweets1';
...
Create table twettesbi_inter as
